...
Step 1: Check the environmental variables and set the 2 new system variable those points to the python.exe files.
...
Step 2: Restart the kernal and try running it. If the issue persists, then go to step 3.
Step 3: Open/run the command prompt with the admin, as we have to link if there is any missing pieces in the process.
